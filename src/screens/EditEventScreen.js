...
export default class CreateEvent extends Component {
  constructor(){
    ...
    this.state = {
      eventName: '',
      eventDate: new Date(),
      repeatEventAnnually: false,
      showDatePicker: false,
      eventWallPaperSource: null
    };
    this.toggleSelectWallPaper = this._toggleSelectWallPaper.bind(this);
    this.handleRepeatToggleSwitch = this._handleRepeatToggleSwitch.bind(this);
  ...
  _handleRepeatToggleSwitch = () => this.setState(state => ({
    repeatEventAnnually: !this.state.repeatAnnually
  }));
